...
class PythonCdkCicdCodeartifactStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        repo = codecommit.Repository(
            ...
            repository_name="PythonSampleRepository",
        )
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            self,
            "/PythonCdkCicdCodeartifactStack/PackagePipeline/Role/DefaultPolicy/Resource",
            [
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            self,
            "/PythonCdkCicdCodeartifactStack/PackagePipeline/Source/CodeCommit/CodePipelineActionRole/DefaultPolicy/Resource",
            [
                NagPackSuppression(id="AwsSolutions-IAM5", reason="Defined by a default policy", applies_to=[
                    "Action::s3:Abort*",
                    "Action::s3:DeleteObject*",
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            self,
            "/PythonCdkCicdCodeartifactStack/RunUnitTests/Role/DefaultPolicy/Resource",
            [
                NagPackSuppression(id="AwsSolutions-IAM5", reason="Defined by a default policy", applies_to=[
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            self,
            "/PythonCdkCicdCodeartifactStack/RunUnitTestsPolicy/Resource",
            [
                NagPackSuppression(id="AwsSolutions-IAM5", reason="Defined by a default policy", applies_to=[
                    "Resource::*",
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            self,
            "/PythonCdkCicdCodeartifactStack/SelfMutate/Role/DefaultPolicy/Resource",
            [
                NagPackSuppression(id="AwsSolutions-IAM5", reason="Defined by a default policy", applies_to=[
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            self,
            "/PythonCdkCicdCodeartifactStack/SelfMutatePolicy/Resource",
            [
                NagPackSuppression(id="AwsSolutions-IAM5", reason="Defined by a default policy", applies_to=[
                    "Resource::*",
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            self,
            "/PythonCdkCicdCodeartifactStack/BuildSamplePackage/sample-package/Role/DefaultPolicy/Resource",
            [
                NagPackSuppression(id="AwsSolutions-IAM5", reason="Defined by a default policy", applies_to=[
        ...
        NagSuppressions.add_resource_suppressions_by_path(
            self,
            "/PythonCdkCicdCodeartifactStack/BuildSamplePackage/PublishPolicy/Resource",
            [
                NagPackSuppression(id="AwsSolutions-IAM5", reason="Defined by a default policy", applies_to=[
                    "Resource::*",
                    "Action::codeartifact:List*"
